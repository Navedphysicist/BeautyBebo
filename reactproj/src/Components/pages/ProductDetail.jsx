        ...
        <div>
            <div id={styles.mainContainer}>
                <div id={styles.mainImg}>
                    <img id={styles.productImage}
                        src={product.imgURL}
                        alt="image" />
                </div>
                <div id={styles.detailDiv}>
                    <h3 id={styles.productTitle}>
                        {product.name}
                    </h3>
                    ...
                    <div id={styles.stockKeep}>
                        <p>SKU &nbsp; &nbsp; <span style={{ color: "gray" }}> BBJ000{Math.floor(Math.random()*1000+1)}</span></p>
                    </div>
                    <div>
                        <strike id={styles.strikePrice}>{product.strikePrice}</strike>
                        <span id={styles.price}>{product.price}</span>
                        <span id={styles.discount}>{Math.ceil(((product.strikePrice - product.price) / (product.strikePrice)) * 100)}% off</span>
                        <p style={{ color: "gray", fontSize: "12px", margin: "5px" }}>(Inclusive of all taxes)</p>
                    </div>
                    <div>
                    ...
                    <div id={styles.cartBtn}>
                        ...
                        <div id={styles.quantity}>
                            ...
                            <input type="text" value={quantity} id={styles.cartQuantity} onChange={(e) => setQuantity(e.target.value)} />
                            <span><i onClick={() => handleQuantity(1)} className="fa-solid fa-angle-up"></i></span>
                        </div>
                    ...
                    <div id={styles.checkPin}>
                        ...
                        {deliverAval && <p style={{ color: "olivedrab", backgroundColor: "beige", padding: "10px", fontSize: "12px", margin: "5px" }}>Delivery Available.</p>}
                    </div>
