    ...
    <div className={styles.parent}>
      <div className={styles.firstChild}>
        ...
        <form onSubmit={handleSubmit}>
          <p>First Name *</p>
          <input type="text" name='firstName' className={styles.input} required="true" value={state.firstName} onChange={handleChange}/>
          <p>Last Name *</p>
          <input type="text" name='lastName'  className={styles.input} required="true" value={state.lastName} onChange={handleChange}/>
          <p>Street Address *</p>
          <input type="text" name='streetAddress'  className={styles.input}  required="true" value={state.streetAddress} onChange={handleChange}/>
          <p>City *</p>
          ...
          <p>ZIP/Postal Code</p>
          <input type="text" name='zipCode'  className={styles.input}  required="true" value={state.zipCode} onChange={handleChange}/>
          <p>Country *</p>
          ...
          <p>Phone Number *</p>
          <input type="text" name='number'  className={styles.input}  required="true" value={state.number} onChange={handleChange}/><br />
